...
import 'package:worldwidenews/presentation/bloc/article/local/local_article_bloc.dart';
...
import 'package:worldwidenews/presentation/widgets/article_tile.dart';
...
class SavedArticles extends HookWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => s1<LocalArticlesBloc>()..add(const GetSavedArticles()),
      child: Scaffold(
        appBar: _buildAppBar(),
        body: _buildBody(),
      ),
